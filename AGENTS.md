...
| A5 | Industry, company size, and urgency are structured picklists. Size maps to sme / mid / enterprise. | The PDF says each enquiry "includes" those attributes. | If they live only in free text, nulls rise. | Open the live form. |
...
| A11 | Hosted mid-tier LLM API, version pinned, routed through the cloud they already have. | The PDF does not specify a model. | Residency may forbid it. Provider swap is a config change. | Ask residency and existing AI vendor. |
...
| A14 | Volume stays under 100/week for this design. | The PDF is 40-60. | At 500/week a queue becomes justified. | Confirm trailing volume. |
